              ...
              <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200/80 dark:border-white/10 px-6 py-4">
                ...
                <div className="hidden md:flex flex-1 justify-end gap-8">
                  <nav className="flex items-center gap-9">
                    ...
                    <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#0d59f2] text-white text-sm font-bold leading-normal tracking-[0.015em]">
